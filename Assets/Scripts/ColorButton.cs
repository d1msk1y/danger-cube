...
public class ColorButton : MonoBehaviour
{
    ...
    public void Buy()
    {
        ...
        camera.gameObject.GetComponent<MeinMenu>().states = customState;
    ...
    {
        if (camera.gameObject.GetComponent<MeinMenu>().states == customState)
        {
            button.enabled = false;
            ramka.SetActive(true);
        }
        else if (camera.gameObject.GetComponent<MeinMenu>().states != customState)
        {
            button.enabled = true;
